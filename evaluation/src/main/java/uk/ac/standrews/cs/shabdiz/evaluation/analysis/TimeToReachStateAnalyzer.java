...
public class TimeToReachStateAnalyzer implements Analyser {

    public static final String STATE_GROUP = "state";
    private final File results_path;

    public TimeToReachStateAnalyzer(File results_path) {
    ...
    public JFreeChart getChart() throws IOException {
        ...
        final JFreeChart chart = ChartFactory.createLineChart("Time to reach uniform state", "Application State", "Time to reach state (s)", dataset, PlotOrientation.VERTICAL, false, false, false);

...
public interface IWorkerRemote {
     ...
     */
    <Result extends Serializable> IFutureRemoteReference<Result> submit(IRemoteJob<Result> remote_job) throws RejectedExecutionException, NullPointerException, RPCException;
}

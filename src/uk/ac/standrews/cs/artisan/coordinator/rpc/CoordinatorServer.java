package uk.ac.standrews.cs.artisan.coordinator.rpc;
...
import uk.ac.standrews.cs.artisan.interfaces.coordinator.ICoordinatorRemote;
import uk.ac.standrews.cs.artisan.worker.rpc.WorkerRemoteMarshaller;
...
public class CoordinatorServer extends ApplicationServer {
    ...
    public static final String APPLICATION_REGISTRY_KEY = "Artisan Coordinator Server";

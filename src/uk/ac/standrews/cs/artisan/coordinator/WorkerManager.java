...
import uk.ac.standrews.cs.artisan.worker.rpc.WorkerRemoteProxy;
import uk.ac.standrews.cs.artisan.worker.rpc.WorkerRemoteServer;
import uk.ac.standrews.cs.artisan.worker.servers.WorkerNodeServer;
...
public class WorkerManager extends ApplicationManager {
    ...
    private static final String APPLICATION_NAME = "Artisan";
    ...
    private void establishApplicationReferenceViaRegistry(final HostDescriptor host_descriptor, final InetSocketAddress inet_socket_address) throws RegistryUnavailableException, RPCException {
        ...
        // Try accessing Artisan via the registry.

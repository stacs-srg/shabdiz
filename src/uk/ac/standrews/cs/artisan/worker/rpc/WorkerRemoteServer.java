package uk.ac.standrews.cs.artisan.worker.rpc;
...
import uk.ac.standrews.cs.artisan.worker.WorkerNodeImpl;
...
public class WorkerRemoteServer extends ApplicationServer {
    ...
    public static final String APPLICATION_REGISTRY_KEY = "Artisan worker server";

...
import uk.ac.standrews.cs.artisan.coordinator.rpc.CoordinatorProxy;
import uk.ac.standrews.cs.artisan.coordinator.rpc.CoordinatorProxyFactory;
...
import uk.ac.standrews.cs.artisan.worker.rpc.RemoteWorkerException;

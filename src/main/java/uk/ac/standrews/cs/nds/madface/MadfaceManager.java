...
public final class MadfaceManager implements IMadfaceManager {
    ...
    @Override
    public void configureApplication(final Class<? extends IApplicationManager> application_manager_class, final Set<URL> application_urls) throws InstantiationException, IllegalAccessException {
    ...
    @Override
    public void configureApplication(final Class<? extends IApplicationManager> application_manager_class, final URL url_base, final Set<String> jar_names, final Set<String> lib_names) throws IOException, InstantiationException, IllegalAccessException {
    ...
    @Override
    public void configureApplication(final IApplicationManager application_manager) {
    ...
    private IApplicationManager getApplicationManager(final Class<? extends IApplicationManager> application_manager_class) throws InstantiationException, IllegalAccessException {

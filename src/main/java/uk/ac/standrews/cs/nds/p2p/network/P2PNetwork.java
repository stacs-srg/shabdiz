...
public class P2PNetwork implements INetwork {
     ...
     */
    public P2PNetwork(final SortedSet<HostDescriptor> host_descriptors, final IApplicationManager application_manager, final Set<URL> application_lib_urls, final KeyDistribution key_distribution) throws Exception {

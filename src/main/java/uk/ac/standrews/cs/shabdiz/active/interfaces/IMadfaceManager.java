...
import uk.ac.standrews.cs.shabdiz.active.TestAppManager;
...
public interface IMadfaceManager {
     ...
     */
    void configureApplication(Class<? extends ApplicationManager> application_manager_class, Set<URL> application_urls) throws InstantiationException, IllegalAccessException;
     ...
     * @throws InstantiationException if the application manager cannot be instantiated
     */
    void configureApplication(Class<? extends ApplicationManager> application_manager_class, URL url_base, Set<String> jar_names, Set<String> lib_names) throws IOException, InstantiationException, IllegalAccessException;
     ...
     */
    void configureApplication(ApplicationManager application_manager);
     ...
     */
    Class<? extends ApplicationManager> getApplicationEntrypoint();
